...
"doc.s3.li1":"<strong>Avec votre compte MEGA</strong> : connectez-vous avec votre e-mail et votre mot de passe pour accéder à l'ensemble de vos fichiers et choisir ceux à ajouter. Vos identifiants sont transmis uniquement aux serveurs de MEGA, jamais à Cloud Music.",
...
"doc.s3.li1":"<strong>With your MEGA account</strong>: sign in with your email and password to access your entire MEGA library and pick the files to add. Your credentials are sent only to MEGA's servers, never to Cloud Music.",
...
"doc.s3.li1":"<strong>使用你的 MEGA 账号</strong>：使用邮箱和密码登录，访问你的整个 MEGA 资料库并选择要添加的文件。你的凭证只会发送给 MEGA 的服务器，绝不会发送给 Cloud Music。",
...
"doc.s3.li1":"<strong>अपने MEGA अकाउंट से</strong>: अपनी पूरी MEGA लाइब्रेरी तक पहुँचने और फ़ाइलें चुनने के लिए ईमेल और पासवर्ड से साइन इन करें। आपकी जानकारी सिर्फ़ MEGA के सर्वर को भेजी जाती है, कभी Cloud Music को नहीं।",
...
"doc.s3.li1":"<strong>Mit deinem MEGA-Konto</strong>: melde dich mit E-Mail und Passwort an, um auf deine gesamte MEGA-Bibliothek zuzugreifen und Dateien auszuwählen. Deine Zugangsdaten gehen nur an die Server von MEGA, niemals an Cloud Music.",
...
"doc.s3.li1":"<strong>Con il tuo account MEGA</strong>: accedi con email e password per accedere a tutta la tua libreria MEGA e scegliere i file da aggiungere. Le tue credenziali vengono inviate solo ai server di MEGA, mai a Cloud Music.",
...
"doc.s3.li1":"<strong>Con tu cuenta MEGA</strong>: inicia sesión con tu correo y contraseña para acceder a toda tu biblioteca MEGA y elegir los archivos a añadir. Tus credenciales se envían solo a los servidores de MEGA, nunca a Cloud Music.",
...
"doc.s3.li1":"<strong>باستخدام حساب MEGA</strong>: سجّل الدخول بالبريد الإلكتروني وكلمة المرور للوصول إلى كامل مكتبتك على MEGA واختيار الملفات لإضافتها. تُرسل بياناتك إلى خوادم MEGA فقط، وليس إلى Cloud Music أبدًا.",
